...
export const WandSparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m22 12-3-3 3-3-3-3-3 3-3-3-3 3 3 3-3 3 3 3 3-3 3 3 3-3Z"/><path d="M6 12V6"/><path d="M3 9h6"/><path d="M18 18h-6"/></svg>
);
...
export const SignatureIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M22 10.5c0 .5-.5 1-1 1H3c-.5 0-1-.5-1-1v-1c0-.5.5-1 1-1H21c.5 0 1 .5 1 1v1Z"/><path d="M7 10.5v1.84c0 1.16.83 2.16 2 2.16h1.5a1.5 1.5 0 0 0 0-3H8.5c-.6 0-1.5.4-1.5 1.5"/><path d="M15.5 10.5c.6 0 1.5.4 1.5 1.5v.34c0 1.16.83 2.16 2 2.16h1.5a1.5 1.5 0 0 0 0-3h-2.5"/></svg>
);
...
export const HandshakeIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M11 17a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h5"></path><path d="M13 7a2 2 0 0 1 2-2h5a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-5"></path><path d="m12 12 2-2 4 4"></path><path d="m8 12-2 2-4-4"></path></svg>
);
...
export const BedIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M2 4v16h20V4Z"/><path d="M2 10h20"/><path d="M6 10v-4"/><path d="M10 10v-4"/><path d="M14 10v-4"/><path d="M18 10v-4"/></svg>
);

export const BathIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M9 6 6 9 3 6"/><path d="M9 12 6 15 3 12"/><path d="m13.5 6 4 4"/><path d="m13.5 10 4-4"/><path d="M2 18h2"/><path d="M2 22h2"/><path d="M5 18v4"/><path d="M22 13h-8a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h8v-10Z"/></svg>
);

export const SquareMetreIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M16 4h4v4"/><path d="m15 5 5 5"/><path d="M4 16v4h4"/><path d="m5 15 5 5"/><rect width="18" height="18" x="3" y="3" rx="2"/></svg>
);

export const MapIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><polygon points="3 6 9 3 15 6 21 3 21 18 15 21 9 18 3 21"></polygon><line x1="9" y1="3" x2="9" y2="18"></line><line x1="15" y1="6" x2="15" y2="21"></line></svg>
);
...
export const PlugIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 22v-5"/><path d="M9 8V2"/><path d="M15 8V2"/><path d="M18 8a6 6 0 0 0-12 0v5a6 6 0 0 0 6 6h0a6 6 0 0 0 6-6V8Z"/></svg>
);
